            ...
            <div class="modal">
                ...
                <Split class="popup-split" leftWidth="50%" rightWidth="50%" >
                    <div class="product-hero-container">
                        ...
                        <p><i><b>Inflated Dimension of 36L x 11W x 19H |</b> Weighs: 375 lbs.</i></p>
                    </div>
                    <div class="pop-text">
                        <h1 class="pop-title">PERFECT FOR ANY EVENT</h1>
                        <h2 class="pop-price"><b>Weekend(Fri. - Sun.)/Holiday Rentals:</b> Start at $275</h2>
                        <h2 class="pop-price"><b>Weekday Rentals:</b> Start at $225</h2>
                        ...
                        <div class="btn-container overlap-btn-container">
                            <a href="mailto: bncollectibles27@gmail.com?subject=RESERVE a Weekend of Unbeatable FUN!"><button class="s-btn">EMAIL TO RESERVE</button></a>
